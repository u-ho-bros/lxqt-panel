    ...
    mPlaceHolder(0)
{
    ...
    QString exec;
    QString icon;
    for (const QHash<QString, QVariant> &app : mPlugin->settings()->readArray("apps"))
    {
...
void LXQtQuickLaunch::saveSettings()
{
    ...
    QList<QHash<QString, QVariant> > hashList;
    ...
    for (int j = 0; j < size; ++j)
    {
        ...
        // convert QHash<QString, QString> to QHash<QString, QVariant>
